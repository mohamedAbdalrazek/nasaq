...
import { formatUrgencyLabel, getUrgencyBadgeClass } from "./lib/helpers";
    ...
    <section className={styles.reviewSection}>
      <div className="container">
        ...
        <div className={styles.reviewHeader}>
          ...
          <h1 className={styles.title}>Request Submitted Successfully!</h1>
          <p className={styles.subtitle}>
            Thank you for your interest in Nasaq. Here&apos;s a summary of your
            project request.
          </p>
        </div>
        ...
        <div className={styles.reviewContent} ref={printRef}>
          ...
          <div className={styles.section}>
            ...
            <div className={styles.fieldGrid}>
              <div className={styles.fieldGroup}>
                ...
                <div className={styles.fieldValue}>{booking.businessName}</div>
              </div>
              <div className={styles.fieldGroup}>
                <label className={styles.fieldLabel}>Industry</label>
                <div className={styles.fieldValue}>{booking.industry}</div>
              </div>
            </div>
          </div>
          ...
          <div className={styles.section}>
            ...
            <div className={styles.fieldGrid}>
              <div className={styles.fieldGroup}>
                <label className={styles.fieldLabel}>Website Purpose</label>
              ...
              <div className={styles.fieldGroup}>
                <label className={styles.fieldLabel}>Existing Website</label>
                <div className={styles.fieldValue}>
                  {booking.hasExistingWebsite
                    ? `Yes - ${booking.existingWebsiteUrl || "URL provided"}`
                    : "No existing website"}
                </div>
              </div>
            </div>
            ...
            {booking.desiredFeatures.length > 0 && (
              <div className={styles.fieldGroup}>
                <label className={styles.fieldLabel}>Desired Features</label>
          ...
          <div className={styles.section}>
            ...
            <div className={styles.fieldGrid}>
              {booking.colorPreferences && (
                <div className={styles.fieldGroup}>
                  <label className={styles.fieldLabel}>Color Preferences</label>
                  <div className={styles.fieldValue}>
                    {booking.colorPreferences}
                  </div>
                </div>
              ...
              {booking.exampleWebsites && (
                <div className={styles.fieldGroup}>
                  <label className={styles.fieldLabel}>Example Websites</label>
                  <div className={styles.fieldValue}>
                    {booking.exampleWebsites}
                  </div>
                </div>
          ...
          <div className={styles.section}>
            ...
            <div className={styles.fieldGrid}>
              <div className={styles.fieldGroup}>
                <label className={styles.fieldLabel}>Preferred Timeline</label>
                <div className={styles.fieldValue}>{booking.timeline}</div>
              </div>
              <div className={styles.fieldGroup}>
                <label className={styles.fieldLabel}>Budget Range</label>
                <div className={styles.budgetValue}>{booking.budgetRange}</div>
              </div>
              {booking.projectUrgency && (
                <div className={styles.fieldGroup}>
                  <label className={styles.fieldLabel}>Project Urgency</label>
                  <div className={styles.fieldValue}>
                    {getUrgencyBadge(booking.projectUrgency)}
                  </div>
                </div>
              )}
            </div>
          ...
          <div className={styles.section}>
            ...
            <div className={styles.fieldGrid}>
              <div className={styles.fieldGroup}>
                ...
                <div className={styles.fieldValue}>{booking.contactName}</div>
              </div>
              <div className={styles.fieldGroup}>
            ...
            <div className={styles.stepsList}>
              ...
              <div className={styles.step}>
                ...
                <div className={styles.stepContent}>
                  ...
                  <p>
                    We&apos;ll contact you via your preferred method to discuss
                    details
                  </p>
                </div>
              </div>
              <div className={styles.step}>
                ...
                <div className={styles.stepContent}>
                  ...
                  <p>You&apos;ll receive a detailed proposal and quotation</p>
                </div>
              </div>
            </div>
          </div>
